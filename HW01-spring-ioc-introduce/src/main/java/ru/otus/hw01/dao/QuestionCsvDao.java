...
public class QuestionCsvDao implements QuestionDao {
    ...
    public QuestionCsvDao(QuestionValidator questionValidator) { //todo path
        try {
            this.csvPath = Paths.get(Objects.requireNonNull(getClass().getClassLoader().getResource("questions.csv")).toURI());
